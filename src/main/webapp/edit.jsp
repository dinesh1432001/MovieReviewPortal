...
<body>
    ...
    <form action="EditReview" method="Post" class="d">
        <div>
            <%
                String title = null;
                String rating = null;
                ...
                String q = "SELECT * FROM INFO WHERE USERNAME=? AND PASSWORD=? ORDER BY title IS NULL, rating IS NULL, review IS NULL";;
                Connection con = null;
                ResultSet rs = null;
                try {
            ...
            %>
                        <div class="review-card">
                            <input type="radio" name="selectedReviews" value="<%=title%>">
            ...
            %>
                   <input type="submit" value="Edit" class="c"><br>
                   <br>
